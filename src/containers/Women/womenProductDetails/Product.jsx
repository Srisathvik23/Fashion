    ...
    <div className="pp-container">
      <div className="pp-product-grid">
        ...
        <div className="pp-product-image">
          <img
            src={require(`../../../assets/Women/${product.image}.png`)}
            alt={product.title}
          />
        </div>
        ...
        <div className="pp-product-info">
          ...
          <div className="pp-buttons">
            <button className="pp-btn pp-add">Add to Cart</button>
            <button className="pp-btn pp-buy">Buy Now</button>
          </div>

          <a
            href={`https://wa.me/919999999999?text=I'm%20interested%20in%20this%20product:%20${product.title}`}
            target="_blank"
